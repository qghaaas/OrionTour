                    ...
                    <div className="travdes-inner">
                        ...
                        <div className="travdes-form">
                            ...
                            <div className="travdes-content">
                                <h3>Забудьте про поиск <br />
                                    и начните путешествие</h3>
                                <p>Мы поможем подобрать для вас уникальные маршруты,
                                    билеты и отели учитвая Ваши предпочтения</p>

                                <input placeholder='Хочу отель на берегу моря в Италии' type="text" />
                            </div>
                        </div>
