                ...
                <div className="container">
                    <div className="footer-inner">
                        ...
                        <ul className='footer-item footer-item_sep'>
                            <li><img src={location} alt="" /><Link to="#"> orion_tour_39</Link></li>
                            <li><img src={phone} alt="" /><Link to="#">+7 (4012) 75-95-99</Link></li>
                            <li><img src={atsign} alt="" /><Link to="#">Калининград,площадь Победы, 4</Link></li>
                        </ul>
